...
- На нейтральных TSD-экранах, где активный рабочий режим не установил собственный scan handler, скан HU выполняет только read-only поиск и показывает выбор навигации. Первый глобальный скан не запускает наполнение, подбор, движение, резервирование, создание или закрытие документа.
