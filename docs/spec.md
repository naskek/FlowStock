...
- Карточка `/hu/{huCode}` является короткой операторской карточкой: основной блок показывает HU, локализованный статус, содержимое, местоположение, связанный заказ и кнопки действий. Технические сведения о документах/latest movement скрыты в раскрываемом блоке `Техническая информация`; raw enum-коды и дубли количества не выводятся в основном блоке.
