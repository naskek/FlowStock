...
- Оставшийся план внутреннего заказа не пересобирается, если его объем совпадает с новым `qty_ordered`; иначе пересборка сохраняет уже назначенные HU на оставшийся объем.
