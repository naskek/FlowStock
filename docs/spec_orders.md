...
- Диагностика производственного плана:
  ...
  - `POST /api/diagnostics/production-plan-consistency/repair` — controlled repair (`mode`, `apply=false` по умолчанию); режим `repair-067-072-mustard` для prod-кейса 067/072;
