...
public sealed class WpfSetOrderStatusService
{
    ...
    private static WpfSetOrderStatusResult MapHttpError(SetOrderStatusApiCallResult apiCall)
    {
        ...
        var message = errorCode switch
        {
            ...
            "ORDER_CANCEL_PRD_HAS_LEDGER" => "Нельзя отменить заказ: по черновику выпуска уже есть движения склада. Сначала оформите корректировку/сторно.",
            "ORDER_CANCEL_PRD_HAS_PALLET_FACTS" => "Нельзя отменить заказ: по черновику выпуска есть фактические паллеты. Сначала отмените/исправьте выпуск.",
        ...
        var kind = errorCode switch
        {
            ...
            "ORDER_CANCEL_PRD_HAS_LEDGER" => WpfSetOrderStatusResultKind.ValidationFailed,
            "ORDER_CANCEL_PRD_HAS_PALLET_FACTS" => WpfSetOrderStatusResultKind.ValidationFailed,
