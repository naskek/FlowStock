...
public sealed class WpfUpdateOrderService
{
    ...
    private static WpfUpdateOrderResult MapHttpError(UpdateOrderApiCallResult apiCall)
    {
        ...
        var message = errorCode switch
        {
            ...
            "ORDER_CANCEL_USE_STATUS_ENDPOINT" => "Для отмены заказа используйте кнопку \"Отменить\".",
        ...
        var kind = errorCode switch
        {
            ...
            "ORDER_CANCEL_USE_STATUS_ENDPOINT" => WpfUpdateOrderResultKind.ValidationFailed,
            ...
            "ITEM_INACTIVE_FOR_ORDER" => WpfUpdateOrderResultKind.ValidationFailed,
