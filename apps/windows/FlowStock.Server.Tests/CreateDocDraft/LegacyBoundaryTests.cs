...
{
    [Fact]
    public async Task ApiOps_RemainsOutsideNormalDraftLifecycle()
    {
        ...
        Assert.Equal(0, apiStore.CountEvents("DOC_CREATE"));
    ...
    public void JsonlImport_RemainsOutsideCanonicalDraftLifecycle()
    {
    }
}
